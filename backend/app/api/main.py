...
from app.api.routes import candles, current, health, signals
...
app = FastAPI(
    ...
    description="Kalshi digital options trading analytics dashboard - See the true odds",
    lifespan=lifespan,
)
